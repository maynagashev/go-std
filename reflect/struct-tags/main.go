// Для каждого поля структуры можно задать теги — строку с дополнительной информацией по этому полю.Например,
// можно указать настройки сериализации в формат JSON.
